...
-- CreateEnum
CREATE TYPE "BookStatus" AS ENUM ('AVAILABLE', 'CHECKED_OUT', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "LoanStatus" AS ENUM ('CHECKED_OUT', 'RETURNED');

-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('BOOK_CREATE', 'BOOK_UPDATE', 'BOOK_ARCHIVE', 'BOOK_UNARCHIVE', 'BOOK_DELETE', 'LOAN_CHECKOUT', 'LOAN_RETURN', 'USER_ROLE_UPDATE');
